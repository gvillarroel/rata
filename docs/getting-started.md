# Rata Synthetic Data Skills: usage and operations
...
| Guides and reference | [Documentation index](README.md) and [command reference](commands.md) | Architecture, privacy model, licensing, commands, requirements, and ADRs. |
...
Read [the privacy model](privacy-model.md) before making a release claim. A passing report is evidence against the
...
See the [documentation index](README.md), [architecture](architecture.md), [command reference](commands.md), [validation record](validation.md), and [licensing boundary](licensing.md).
...
See the [evaluation state-of-the-art report](evaluation-state-of-art.md) and its
